  ...
  return (
    ...
    >
      <div className="flex items-center gap-5">
        ...
        <div>
          {isLoading ? (
            <div className="h-7 w-48 bg-gray-200 border-2 border-black shadow-[2px_2px_0px_#000] animate-pulse" />
          ) : (
          ...
          <div className="font-mono text-sm uppercase tracking-wide flex items-center gap-3 mt-2">
            {isLoading ? (
              <div className="h-5 w-32 bg-gray-200 border-2 border-black shadow-[2px_2px_0px_#000] animate-pulse mt-1" />
            ) : (
              <>
