...
import { LeaderboardPodium } from '@/features/game/LeaderboardPodium';
...
import { Player } from '@/features/game/useFinalLeaderboard';
import { ChampionEffects } from '@/shared/ui/ChampionEffects';
